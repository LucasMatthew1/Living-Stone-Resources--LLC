        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {points.map((point, i) => (
            <motion.div
              ...
              className="relative"
            >
              <span className="text-brand-purple/10 text-6xl md:text-7xl lg:text-8xl font-display font-bold absolute -top-12 left-0 md:-left-6 z-0 select-none hidden md:block">
                {point.num}
              </span>
